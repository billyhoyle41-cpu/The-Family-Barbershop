...
import brendaImg from "@assets/generated_images/highly_stylish_chic_older_female_barber_glasses.png";
...
export default function Home() {
  return (
    <Layout>
      ...
      {/* Quick Info Bar */}
      <section className="bg-white relative z-30 pt-16 container mx-auto px-4">
